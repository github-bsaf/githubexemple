	...
	/*  add  */
     zeedddd;	
	   m_i1MinFiltSum_DU_tmpee = (sint32)(m_i1MinFiltSum_DU_div * (LAT_I1_FILTER_GRADE - 1)) + (sint32)(((m_i1MinFiltSum_DU_mod * (LAT_I1_FILTER_GRADE - 1)) - (LAT_I1_FILTER_GRADE / 2)) / LAT_I1_FILTER_GRADE);
	}